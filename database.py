...
def crear_tabla_usuarios():
    ...
    try:
        ...
        conn.rollback()
        print("Error en crear_tabla_usuarios", e)
...
def insertar_maquina(tipo, activo_fijo, numero_equipo, modelo, fabricante, estado_operacion, sede_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_maquina", e)
        return None
...
def obtener_maquinas():
    ...
    try:
        ...
        print("Error en obtener_maquinas:", e)
        return []
...
def obtener_maquina_por_id(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_maquina_por_id", e)
        return None
...
def eliminar_maquina(id_maquina):
    ...
    try: 
        ...
        conn.rollback()
        print("Error en eliminar_maquina", e)
...
def actualizar_maquina(id, tipo, activo_fijo, numero_equipo, modelo, fabricante, estado_operacion, sede_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_maquina", e)
...
def conteo_maquinas_por_sede():
    ...
    try:
        ...
        conn.rollback()
        print("Error en conteo_maquinas_por_sede", e)
        return []
...
def obtener_tipos_maquina():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_tipos_maquina", e)
        return []
...
def insertar_sede(nombre, ciudad):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_sede", e)
...
def obtener_sedes():
    ...
    try: 
        ...
        print("Error en obtener_sedes:", e)
        return []
...
def obtener_sedes_diff():
    ...
    try: 
        ...
        conn.rollback()
        print("Error en obtener_sedes_diff", e)
        return []
...
def sede_tiene_maquinas(sede_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en sede_tiene_maquinas", e)
        return 0
...
def eliminar_sede(id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en eliminar_sede", e)
...
def insertar_traslado(maquina_id, sede_origen, sede_destino, fecha, responsable, observaciones):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_traslado", e)
...
def obtener_traslados():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_traslados", e)
        return []
...
def obtener_ultimos_traslados(limit=10):
    ...
    try: 
        ...
        conn.rollback()
        print("Error en obtener_ultimos_traslados", e)
        return []
...
def insertar_checklist(maquina_id, fecha, origen, operario_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error insertando checklist:", e)
        return None
...
def insertar_item_checklist(checklist_id, item, cumple, observaciones, item_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_item_checklist:", e)
...
def obtener_checklists():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists", e)
        return []
...
def obtener_ultimos_checklists_por_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ultimos_checklists_por_maquina", e)
        return []
...
def obtener_items_checklist(checklist_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_items_checklists", e)
        return []
...
def eliminar_checklist(checklist_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en eliminar_checklists", e)
...
def obtener_ultimos_checklists(limit=10):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ultimos_checklists", e)
        return []
...
def obtener_checklists_por_ciudad(ciudad):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists por sede", e)
        return []
...
def obtener_checklists_por_sede(sede):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists_por_sede", e)
        return []
...
def obtener_categorias(tipo_maquina):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_categoria", e)
        return []
...
def obtener_items(categoria_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_items", e)
        return []
...
def crear_categoria(nombre, tipo_maquina, orden):
    ...
    try:
        ...
        conn.rollback()
        print("Error en crear_categoria", e)
...
def desactivar_item(item_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en desactivar_item", e)
...
def actualizar_orden_item(item_id, nuevo_orden):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_orden_item", e)
...
def obtener_checklists_paginados(limit, offset):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists paginados", e)
        return []
...
def contar_checklists():
    ...
    try:
        ...
        conn.rollback()
        print("Error en contar_chekcklists", e)
        return 0
...
def obtener_detalle_checklist(checklist_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_detalle_checklist", e)
        return []
...
def obtener_checklists_filtrados(limit, offset, fecha_inicio=None, fecha_fin=None, tipo_maquina=None, maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists_filtrados", e)
        return []
...
def contar_checklists_filtrados(fecha_inicio=None, fecha_fin=None, tipo_maquina=None, maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en contar_checklists_filtrados", e)
        return 0
...
def obtener_checklists_export(fecha_inicio=None, fecha_fin=None, tipo_maquina=None, maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists_export", e)
        return []
...
def existe_checklist_dia(maquina_id, fecha):
    ...
    try:
        ...
        conn.rollback()
        print("Error en existe_checklist_dia:", e)
        return False
...
def solicitud_pendiente_existente(maquina_id, descripcion):
    ...
    try:
        ...
        print("Error en solicitud_pendiente_existente:", e)
        return False
...
def insertar_solicitud(maquina_id, item_falla, observacion, origen):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_solicitud:", e)
        return False, 0
...
def obtener_solicitudes_pendientes():
    ...
    try:
        ...
        print("Error en obtener_solicitudes_pendientes:", e)
        return []
...
def cerrar_solicitud(solicitud_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en cerrar_solicitud:", e)
...
def obtener_todas_solicitudes():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_todas_solicitudes", e)
        return []
...
def obtener_solicitudes_pendientes_por_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_solicitudes_pendientes_por_maquina", e)
        return []
...
def actualizar_estado_por_solicitudes(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_estado_por_solicitudes", e)
...
def actualizar_estado_maquina(maquina_id, nuevo_estado):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_estado_maquina", e)
...
def obtener_solicitudes_filtradas(ciudad=None, sede=None, tipo=None, maquina=None, pagina=1, limite=15):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_solicitudes_filtradas", e)
        return []
...
def contar_solicitudes_filtradas(ciudad=None, sede=None, tipo=None, maquina=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en contar_solicitudes_filtradas", e)
        return []
...
def resumen_estados_solicitudes(ciudad=None, sede=None, tipo=None, maquina=None):
    ...
    try: 
        ...
        conn.rollback()
        print("Error en resumen_estados_solicitudes", e)
        return 0,0,0
...
def obtener_solicitudes_export(ciudad=None, sede=None, tipo=None, maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_solicitudes_export", e)
        return []
...
def obtener_mantenimientos_paginados(pagina, registros_por_pagina=15):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_mantenimientos_paginados:", e)
        return []
...
def contar_mantenimientos():
    ...
    try:
        ...
        conn.rollback()
        print("Error en contar_mantenimientos:", e)
        return 0
...
def obtener_mantenimientos_por_maquina(maquina_id):
    ...
    try: 
        ...
        conn.rollback()
        print("Error en obtener_mantenimientos_por_maquina:", e)
        return []
...
def obtener_todos_mantenimientos():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_todos_mantenimientos:", e)
        return []
...
def obtener_mantenimientos_con_solicitudes(maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_mantenimientos_con_solicitudes:", e)
        return []
...
def actualizar_mantenimiento(mantenimiento_id, tecnico, recibido_por, observaciones):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_mantenimiento:", e)
...
def obtener_descripciones_solicitudes(ids_str):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_descripciones_solicitudes:", e)
        return "Error al obtener solicitudes"
    finally:
        cursor.close()
        connection_pool.putconn(conn)
...
def insertar_costo(mantenimiento_id, tipo, descripcion, cantidad, costo_unitario):
    ...
    try:
        ...
        conn.rollback()
        print("Error en insertar_costo:", e)
...
def obtener_costos_por_mantenimiento(mantenimiento_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costos_por_mantenimiento:", e)
        return []
...
def actualizar_costo(costo_id, descripcion, cantidad, costo_unitario):
    ...
    try:
        ...
        conn.rollback()
        print("Error en actualizar_costo:", e)
...
def eliminar_costo(costo_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en eliminar_costo:", e)
    finally:
        cursor.close()
        connection_pool.putconn(conn)
...
def obtener_mantenimientos_export(maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_mantenimientos_export:", e)
        return []
    finally:
        cursor.close()
        connection_pool.putconn(conn)
...
def obtener_mantenimientos_con_costos_export(maquina_id=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_mantenimientos_con_costos_export:", e)
        return [], []
...
def obtener_costo_total_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costo_total_maquina:", e)
        return 0
...
def obtener_total_por_mantenimiento(mantenimiento_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_total_por_mantenimiento:", e)
        return 0
...
def obtener_ultimas_solicitudes(maquina_id, limite=3):
    ...
    try: 
        ...
        conn.rollback()
        print("Error en obtener_ultimas_solicitudes:", e)
        return []
...
def obtener_costos_por_maquina(maquina_id, limite=10):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costos_por_maquina:", e)
        return []
...
def obtener_solicitudes_por_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_solicitudes_por_maquina:", e)
        return []
...
def obtener_checklists_por_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_checklists_por_maquina:", e)
        return []
...
def obtener_traslados_por_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_traslados_por_maquina:", e)
        return []
...
def obtener_indicadores_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_indicadores_maquina:", e)
        return {}
...
def obtener_ubicacion_maquina(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ubicacion_maquina:", e)
        return None
...
def obtener_ultimo_traslado(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ultimo_traslado:", e)
        return None
...
def obtener_historial_estado(maquina_id):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_historial_estado:", e)
        return []
...
def obtener_resumen_general():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_resumen_general:", e)
        return {}
...
def obtener_top_fallas():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_top_fallas:", e)
        return []
...
def obtener_top_fallas_por_maquina():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_top_fallas_por_maquina:", e)
        return []
...
def obtener_ultimos_mantenimientos_dashboard():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ultimos_mantenimientos_dashboard:", e)
        return []
...
def calcular_disponibilidad():
    ...
    try:
        ...
        conn.rollback()
        print("Error en calcular_disponibilidad:", e)
        return 0
...
def obtener_alertas():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_alertas:", e)
        return []
...
def obtener_ranking_maquinas():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ranking_maquinas:", e)
        return []
...
def obtener_costos_dashboard():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costos_dashboard:", e)
        return []
...
def obtener_costos_filtrados(fecha_inicio=None, fecha_fin=None, tipo=None, maquina=None, tipo_costo=None):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costos_filtrados:", e)
        return []
...
def obtener_kpis_costos():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_kpis_costos:", e)
        return 0, 0, 0, None
...
def obtener_ranking_costos_maquinas(limite=5):
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_ranking_costos_maquinas:", e)
        return []
...
def obtener_costos_por_mes():
    ...
    try:
        ...
        conn.rollback()
        print("Error en obtener_costos_por_mes:", e)
        return []
...
def crear_tabla_operarios():
    ...
    try:
        ...
        conn.rollback()
        print("Error en crear_tabla_operarios:", e)
    ...
    try:
        ...
        BEGIN
            IF NOT EXISTS (
                ...
                ALTER TABLE checklists ADD COLUMN operario_id INTEGER;
            END IF;
        END
        $$;
        """)
        ...
        conn.rollback()
        print("Error en agregar_columna_operario:", e)
...
def agregar_sede_operario():
    ...
    try:
        ...
        conn.rollback()
        print("Error en agregar_sede_operario:", e)
...
def obtener_operario_por_cedula(cedula):
    ...
    try:
        ...
        print("Error en obtener_operario_por_cedula:", e)
        return None
...
def obtener_historial_operarios(filtro_sede=None, filtro_tipo=None):
    ...
    try:
        ...
        print("Error en obtener_historial_operarios:", e)
        return []
...
def obtener_control_diario_operarios():
    ...
    try:
        ...
        print("Error en obtener_control_diario_operarios:", e)
        return 0, 0
...
def obtener_operarios_pendientes(filtro_sede=None):
    ...
    try:
        ...
        print("Error en obtener_operarios_pendientes:", e)
        return []
...
def obtener_kpi_por_sede():
    ...
    try:
        ...
        print("Error en obtener_kpi_por_sede:", e)
        return []
...
def obtener_kpi_real_por_sede():
    ...
    try:
        ...
        print("Error en obtener_kpi_real_por_sede:", e)
        return []
